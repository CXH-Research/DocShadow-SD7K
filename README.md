...
# 🎉 Important news  
**[01/05/2024:]** We compressed the SD7K as much as possible while ensuring image quality remains unchanged. The resolution stays the same (2K), but the size is now only 20% of the original. It would now be more convenient to follow and play with. The 'Dataset' indicates the compressed one, the 'Original Dataset' means the original size (100G).
